...
/*   Updated: 2021/04/04 22:21:22 by ejosue-b         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_putchar(int size_x, int size_y, int pos_x, int pos_y)
{
	...
	if (pos_y == 0 || pos_y == size_y - 1)
		c = 'B';
	(pos_x == 0 && pos_y == 0) ? c = 'A' : 'null';
	(pos_x == (size_x - 1) && pos_y == (size_y - 1)) ? c = 'A' : 'null';
	(pos_x == (size_x - 1) && pos_y == 0) ? c = 'C' : 'null';
	(pos_x == 0 && pos_y == (size_y - 1)) ? c = 'C' : 'null';
	write(1, &c, 1);
}
